...
-- Limpeza (Se necessário, caso já exista né)
...
-- Povoando as tabelas com dados Dummy:
    ...
    -- Inserir Vendas (CORRIGIDO)
        INSERT INTO dbo.vendas (id_cliente, id_produto, quantidade, valor_total, data_venda) VALUES
        (1, 1, 1, 3500.00, '2025-10-01 10:30:00'),  -- João compra Notebook
        (2, 4, 2, 130.00, '2025-10-01 14:20:00'),   -- Maria compra 2 Clean Code
        (3, 6, 1, 129.90, '2025-10-02 09:15:00'),   -- Pedro compra Calça Jeans
        (4, 9, 1, 899.00, '2025-10-02 16:45:00'),   -- Ana compra Mesa
        (5, 8, 2, 25.00, '2025-10-03 11:00:00'),    -- Carlos compra 2 Camarões
        (1, 2, 2, 179.80, '2025-10-04 13:30:00'),   -- João compra 2 Mouses
        (2, 10, 1, 1200.00, '2025-10-05 10:00:00'), -- Maria compra Cadeira
        (3, 3, 1, 85.00, '2025-10-06 15:20:00');    -- Pedro compra Dom Casmurro
        GO
